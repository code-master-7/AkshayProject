		...
		if ($img_size > 1250000) {
			...
			if (in_array($img_ex_lc, $allowed_exs)) {
				...
				if (isset($_POST['work'])) {
					...
					echo $image_idd;
					$sql = "UPDATE images SET image_url = '$new_img_name' , image_des = '$_POST[imgDes]' where image_id  = '$image_idd';";
					echo "UPDATEEEEEEEEEEEEEEEE";
				} else {
					echo "Isert";
					// Insert into Database
					$sql = "INSERT INTO images VALUES('','$new_img_name','$_POST[imgDes]','$email','$_POST[pID]','$id',' $title');";
				}
