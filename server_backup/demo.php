...
if (isset($_GET['id'])) {
                                                ...
                                                <form action="upload.php" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div>
                                                                    <textarea class="mx-1 my-1" name="imgDes" id="imgDesInsert"
                                                                        required> </textarea>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div>
                                                                    <input type="submit" class="btn btn-success " name="submit" onclick="return validate('imgDesInsert');"
                                                                        value="Insert Data">
                                                                </div>
                                                            </td>
                                                        </tr>
   ...
   left: 0px; opacity:1; height: 100%; width:100%; margin:0 0 auto 0 ;opacity: 1 ;color:white">
                            ...
                            while ($Details = mysqli_fetch_assoc($getData)) {
                                ...
                                <form action="upload.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <tr>
                                        ...
                                        <td><textarea name="imgDes" id="imgDes" style="margin:10px"
                                                autofocus><?php echo $Details['image_des']; ?></textarea>
                                        </td>
                                        <td><input type="submit" style="margin-left:auto; margin-right: 0;" class="btn btn-success"
                                                name="submit" onclick="return validate('imgDes');" value="Update text"></td>
                                    </tr>
                                    </table>
                                </form>
                                <?php
        ...
        <script>
            function validate(idd){
                let id = "#" + idd;
            
               let data = document.querySelector(id).value
        
               let dataa = data.replaceAll('\'',"\\'");
        
               document.querySelector(id).value = dataa
