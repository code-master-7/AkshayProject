			...
			if (in_array($img_ex_lc, $allowed_exs)) {
				if (isset($_POST['create'])) {
					...
					if (isset($_POST['work'])) {
					 ...
					 $sql = "INSERT INTO `images`(`image_url`, `image_des`, `email`, `post_id`, `project_id`, `post_title`, `typ`) VALUES('$new_img_name','$_POST[imgDes]','$email','$_POST[pID]','$id',' $title','$mod');";
					}
	...
	if (isset($_POST['work'])) {
		if ($_POST['work'] == "UpdateText") {
			...
			include "enc.php";
		 	...
		 	$sql = "UPDATE `images` SET `image_des` = '$_POST[imgDes]' where `images`.`image_id`  = '$image_idd';";
			// 			echo "UPDATEEEEEEEEEEEEEEEE";
			mysqli_query($con_server, $sql);
			header("location: demo.php?id=$_POST[id]");
